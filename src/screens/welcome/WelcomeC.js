...
import {
  ImageBackground, SafeAreaView, StatusBar, StyleSheet, View
} from 'react-native';
...
export default class WelcomeC extends Component {
  ...
  render() {
    return (
      <ImageBackground source={bgImg} style={styles.bgImg} imageStyle={styles.opacity}>
        <SafeAreaView style={styles.screenContainer}>
          <StatusBar backgroundColor={Colors.statusBarColor} barStyle="dark-content" />

          <View style={styles.logoContainer}>
            <Logo size={120} tintColor={Colors.accentColor} />
          </View>
